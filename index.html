...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .delete-row-btn { background: #f44336; color: white; border: none; border-radius: 3px; width: 24px; height: 24px; cursor: pointer; font-size: 18px; line-height: 1; padding: 0; flex-shrink: 0; font-weight: bold; transition: background 0.3s; }
        ...
        @media print { .setup-banner, .sync-status, .team-buttons, .week-navigation, .btn-print, .no-print, .delete-row-btn { display: none !important; } }
    </style>
</head>
<body>
    ...
    <div class="container">
        <div class="setup-banner" id="setupBanner">
            <h3>⚙️ Configuration Firebase (Une seule fois)</h3>
            ...
            <button onclick="saveFirebaseConfig()">💾 Enregistrer et activer</button>
        </div>
        <div class="header">
            <h1>Planning Hebdomadaire Astec-sud-ouest</h1>
            <div class="logo-container">
                <div style="display: flex; gap: 15px; align-items: center;">
                    <div><label for="yearSelect">Année : </label><select id="yearSelect" class="year-selector"></select></div>
        ...
        <div class="legend">
            ...
            <div class="legend-item"><div class="legend-color legend-charge"></div><span>Chargé d'affaire</span></div>
            <div class="legend-item"><div class="legend-color legend-charge-stagiaire"></div><span>Chargé d'affaire Stagiaire/Alternant</span></div>
            ...
            <div class="legend-item"><div class="legend-color vacation"></div><span>Congés</span></div>
            <div class="legend-item"><div class="legend-color legend-arret"></div><span>Arrêt de travail</span></div>
            <div class="legend-item"><div class="legend-color holiday"></div><span>Jour férié</span></div>
        </div>
    ...
    <div id="teamModal" class="modal">
        <div class="modal-content">
            ...
            <div class="form-group"><label>Nom du personnel</label><input type="text" id="personnelName" placeholder="Nom et prénom"></div>
    ...
    <div id="vacationModal" class="modal">
        <div class="modal-content">
            <div class="modal-header"><h2>Gestion des Congés</h2><span class="close" onclick="closeVacationModal()">&times;</span></div>
            <div class="form-group"><label>Personnel</label><select id="vacationPersonnelSelect" class="day-select"></select></div>
            <div class="form-group"><label>Date de début</label><input type="date" id="vacationStartDate"></div>
            <div class="form-group"><label>Date de fin</label><input type="date" id="vacationEndDate"></div>
            <div class="form-group"><label class="checkbox-label"><input type="checkbox" id="arretTravail">Arrêt de travail</label></div>
    ...
    <div id="workModal" class="modal">
        <div class="modal-content">
            <div class="modal-header"><h2>Détails de l'affectation</h2><span class="close" onclick="closeWorkModal()">&times;</span></div>
            ...
            <div class="form-group"><label>Appliquer à :</label>
            ...
            <div class="delete-options" id="deleteOptions" style="display:none;">
                ...
                <button class="btn btn-danger" onclick="deleteAllSelectedDays()">Tous les jours sélectionnés</button>
            </div>
        </div>
    </div>
